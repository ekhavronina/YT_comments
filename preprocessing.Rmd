...
write.csv(women_en, "women_en.csv", fileEncoding = "utf-8", row.names = F)
...
write.csv(men_en, "men_en.csv", fileEncoding = "utf-8", row.names = F)
```
...
women_ru <- women_ru_ds %>% 
  bind_rows(women_ru_p)
...
write.csv(women_ru, "women_ru.csv", fileEncoding = "utf-8", row.names = F)
```
